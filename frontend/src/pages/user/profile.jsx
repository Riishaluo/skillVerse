                            ...
                            <div>
                                {onlyPosts.length > 0 ? (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {onlyPosts.map((post) => (
                                            <div key={post._id} className="border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-all duration-300 bg-white">
                                                {post.photo ? (
                                                    ...
                                                    <div className="aspect-video bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
                                                        <div className="text-center">
                                                            ...
                                                            <p className="text-gray-400 text-xs">Text Post</p>
                                                        </div>
                                                    </div>
                                                )}

                                                <div className="p-3">
                                                    <p className="text-gray-700 text-xs line-clamp-2 mb-2 leading-relaxed">
                                                                    ...
                                                                    <div key={c._id} className="flex items-start gap-2">
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                            <div className="bg-gray-50 rounded-xl px-3 py-2 border border-gray-100">
                                                                                <strong className="text-gray-800 text-xs font-semibold block mb-0.5">
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-400 text-xs mt-1">Share your first post to get started</p>
                                    </div>
                                )}
                            </div>
                        )}
                            ...
                            <div className="space-y-4">
                                {onlyEvents.length > 0 ? (
                                    onlyEvents.map((event) => (
                                        <div key={event._id} className="border border-gray-100 rounded-lg p-4 hover:shadow-sm transition-all duration-300 bg-white">
                                            <div className="flex items-start gap-2 mb-3">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-gray-800 text-sm leading-relaxed mb-2">{event.description || "No description available"}</p>
                                                    {event.createdAt && (
                                            ...
                                            {event.photo && (
                                                <div className="rounded-lg overflow-hidden mb-3">
                                                    <img src={event.photo} alt="Event" className="w-full max-h-48 object-cover hover:scale-105 transition-transform duration-300" />
                                                </div>
                                            )}
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-400 text-xs mt-1">Create your first event to bring people together</p>
                                    </div>
                                )}
                            </div>
                        )}
